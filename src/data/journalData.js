export const journalData = [
  ...
  // Adding some entries for previous months to demonstrate scrolling
  {
    imgUrl:
      "https://images.pexels.com/photos/1319460/pexels-photo-1319460.jpeg",
    rating: 4.1,
    categories: ["Wash Day", "Weekly Routine"],
    date: "15/07/2025",
    description:
      "Regular wash day routine with my favorite sulfate-free shampoo. Hair feels clean and bouncy.",
  },
  {
    imgUrl:
      "https://images.pexels.com/photos/1557843/pexels-photo-1557843.jpeg",
    rating: 4.9,
    categories: ["Deep Treatment", "Repair"],
    date: "22/07/2025",
    description:
      "Intensive repair treatment for damaged ends. Amazing results after just one session!",
  },
  {
    imgUrl:
    ...
    date: "10/10/2025",
    description:
      "Tried blow drying with a new heat protectant. Good results but still prefer air drying for healthier hair.",
  },
  {
    imgUrl:
      "https://images.pexels.com/photos/1362048/pexels-photo-1362048.jpeg",
    rating: 4.4,
    categories: ["Moisturizing", "Natural Oils"],
    date: "18/10/2025",
    description:
      "Applied argan oil to damp hair. Perfect amount of moisture without weighing hair down.",
  },
];
